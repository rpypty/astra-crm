...
func (q *Queries) CalculateTeamleadCurrentSummary(ctx context.Context, arg CalculateTeamleadCurrentSummaryParams) (CalculateTeamleadCurrentSummaryRow, error) {
	row := q.db.QueryRow(ctx, calculateTeamleadCurrentSummary, arg.TeamID, arg.Direction, arg.UploadedBy)
...
type CountTraderInboundRequisiteMismatchesParams struct {
	TeamID   int64
	TraderID int64
	ShiftID  int64
}

func (q *Queries) CountTraderInboundRequisiteMismatches(ctx context.Context, arg CountTraderInboundRequisiteMismatchesParams) (int64, error) {
	row := q.db.QueryRow(ctx, countTraderInboundRequisiteMismatches, arg.TeamID, arg.TraderID, arg.ShiftID)
	var column_1 int64
	err := row.Scan(&column_1)
	return column_1, err
}
...
const createTraderInboundRequisiteMismatchItems = `-- name: CreateTraderInboundRequisiteMismatchItems :many
WITH crm_requisites AS (
    SELECT
        sr.id AS shift_requisite_id,
...
type CreateTraderInboundRequisiteMismatchItemsParams struct {
	RunID    int64
	TeamID   int64
	TraderID int64
	ShiftID  int64
...
func (q *Queries) CreateTraderInboundRequisiteMismatchItems(ctx context.Context, arg CreateTraderInboundRequisiteMismatchItemsParams) ([]int64, error) {
	rows, err := q.db.Query(ctx, createTraderInboundRequisiteMismatchItems,
		arg.RunID,
		arg.TeamID,
		arg.TraderID,
		arg.ShiftID,
...
const createTraderOutboundReconciliationItems = `-- name: CreateTraderOutboundReconciliationItems :many
...
type CreateTraderOutboundReconciliationItemsParams struct {
	RunID    int64
	TeamID   int64
	TraderID int64
	ShiftID  int64
...
func (q *Queries) CreateTraderOutboundReconciliationItems(ctx context.Context, arg CreateTraderOutboundReconciliationItemsParams) ([]int64, error) {
	rows, err := q.db.Query(ctx, createTraderOutboundReconciliationItems,
		arg.RunID,
		arg.TeamID,
		arg.TraderID,
		arg.ShiftID,
...
const updateTraderInboundRequisiteReviewStatuses = `-- name: UpdateTraderInboundRequisiteReviewStatuses :exec
...
type UpdateTraderInboundRequisiteReviewStatusesParams struct {
	TeamID   int64
	TraderID int64
	ShiftID  int64
}

func (q *Queries) UpdateTraderInboundRequisiteReviewStatuses(ctx context.Context, arg UpdateTraderInboundRequisiteReviewStatusesParams) error {
	_, err := q.db.Exec(ctx, updateTraderInboundRequisiteReviewStatuses, arg.TeamID, arg.TraderID, arg.ShiftID)
	return err
}
