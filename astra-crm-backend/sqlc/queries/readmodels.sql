...
WHERE osi.team_id = sqlc.arg(team_id)
  ...
  AND (sqlc.narg(created_from)::timestamptz IS NULL OR osi.created_at_external >= sqlc.narg(created_from)::timestamptz)
  AND (sqlc.narg(created_to_exclusive)::timestamptz IS NULL OR osi.created_at_external < sqlc.narg(created_to_exclusive)::timestamptz)
...
-- name: ListTraderOrdersCreatedDesc :many
SELECT
...
-- name: ListTraderOrdersCreatedAsc :many
SELECT
    osi.id AS scope_item_id,
    osi.external_order_id,
    osi.external_id,
...
-- name: ListTraderOrdersAmountAsc :many
SELECT
    osi.id AS scope_item_id,
    osi.external_order_id,
    osi.external_id,
...
-- name: ListTraderOrdersAmountDesc :many
SELECT
    osi.id AS scope_item_id,
    osi.external_order_id,
    osi.external_id,
...
-- name: ListTeamleadOrdersCreatedDesc :many
SELECT
    osi.id AS scope_item_id,
    osi.external_order_id,
    osi.external_id,
...
-- name: ListTeamleadOrdersCreatedAsc :many
SELECT
    osi.id AS scope_item_id,
    osi.external_order_id,
    osi.external_id,
...
-- name: ListTeamleadOrdersAmountAsc :many
SELECT
    osi.id AS scope_item_id,
    osi.external_order_id,
    osi.external_id,
...
-- name: ListTeamleadOrdersAmountDesc :many
SELECT
    osi.id AS scope_item_id,
    osi.external_order_id,
    osi.external_id,
